        ...
        <Toolbar>
          ...
          <div className="wd-td-none wd-fg-white me-3">
            <Typography variant="h6" component="div"
              ...
              {isUserLoggedIn && <p
                  className={'fs-6 mb-0'}>Hello, {user?.firstName}</p>}
            </Typography>
            <div className="dropdown">
              ...
              <ul className="dropdown-menu">
                <li><Link to={'/Account/Profile'} className="dropdown-item">My
                  Profile</Link></li>
                <li><Link to={'/Account/Orders'} className="dropdown-item">My
                  Orders</Link>
                </li>
                <li><Link to={'/Account/Wishlist'}
                          className="dropdown-item">Wishlist</Link>
                </li>
                {isUserLoggedIn &&
                    <>
                      <li>
                      ...
                      <li>
                        <div className={'dropdown-item alert-danger'}
