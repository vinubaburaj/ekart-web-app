...
import { Search as SearchIcon, Home as HomeIcon, Person as PersonIcon, Settings as SettingsIcon } from '@mui/icons-material';
import './index.css';
            ...
            <Toolbar>
                ...
                <div className="wd-search-container">
                    <div className="wd-search-box">
                        ...
                        <IconButton className="wd-search-icon wd-fg-white" aria-label="search">
                            <SearchIcon />
                        </IconButton>
                    </div>
                </div>
